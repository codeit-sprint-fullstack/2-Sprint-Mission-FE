		...
		<main className={styles.main}>
			...
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<div className={styles.pwd_container}>
					...
					<img src={pwdIsVisible ? "/images/btn_visibility_on_24px.svg" : "/images/btn_visibility_off_24px.svg"} alt="Button visibility off" onClick={() => setPwdIsVisible(prev => !prev)} />
				</div>
				...
				<div className={styles.pwd_container}>
					...
					<img src={pwdCfmIsVisible ? "/images/btn_visibility_on_24px.svg" : "/images/btn_visibility_off_24px.svg"} alt="Button visibility off" onClick={() => setPwdCfmIsVisible(prev => !prev)} />
				</div>
