...
function PageEntire({ onChangePage, pageInfo, className }) {
  ...
  return (
    <div id="page-entire" className={className}>
      ...
      <PageArrow onChangePageGroup={handleNextPageGroup} pageInfo={pageInfo}>
        {">"}
      </PageArrow>
    </div>
  );
