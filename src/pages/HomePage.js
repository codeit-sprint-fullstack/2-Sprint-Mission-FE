import sBanner1 from "../assets/sbanner1.png";
import sBanner2 from "../assets/sbanner2.png";
import sBanner3 from "../assets/sbanner3.png";
      ...
      <div className={styles.banners}>
        <div className={styles.midBanner}>
          <div className={styles.bannerLeftAligned}>
            <div>
              <img className={styles.banImg} src={sBanner1} />
            </div>
          ...
          <div className={styles.rightAligned}>
            <div className={styles.bannerRightAligned}>
              ...
              <div>
                <img className={styles.banImg} src={sBanner2} />
              </div>
            </div>
          </div>
          <div className={styles.bannerLeftAligned}>
            <div>
              <img className={styles.banImg} src={sBanner3} />
            </div>
            <div className={styles.leftsided}>
