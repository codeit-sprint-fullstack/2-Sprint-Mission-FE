...
## 주요 변경사항
  - 공통 모듈 완료
  - 태블릿 및 모바일 랜딩페이지 배너 이미지 가운데 정렬하기 완료
  - footer 컨텐츠 위치 조정 완료
...
## 멘토에게
- 심화 요구사항 중 sns에서 미리보기와 모달은 구현하지 않았습니다.
- 심화 랜딩: Mobile 사이즈 너비가 커지면 ~ 이 부분을 제대로 구현한건지 모르겠습니다... 요구사항이 잘 이해가 안돼서 흐지부지로 한 것 같습니다.
- netlify: https://pandasprint4.netlify.app/
- 
